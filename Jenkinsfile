pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://16.171.116.105:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/2300032531/Practical3-backend.git', branch: 'master'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://16.171.116.105:9090/springapp1"
            echo "✅ Frontend deployed: http://16.171.116.105:9090/frontapp1"
        }
        failure {
